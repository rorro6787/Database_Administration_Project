...
--------------------------------------------------------
  ...
  CREATE TABLE "LIFEFIT"."DIETA" 
   (	"ID" NUMBER, 
	"NOMBRE" VARCHAR2(40 BYTE) NOT NULL UNIQUE, 
...
--------------------------------------------------------
  ...
  ALTER TABLE "LIFEFIT"."CITA" ADD CONSTRAINT "CITA_CLIENTE_FK" FOREIGN KEY ("CLIENTE_ID")
	  REFERENCES "LIFEFIT"."CLIENTE" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "LIFEFIT"."CITA" ADD CONSTRAINT "CITA_ELEMENTOCALENDARIO_FK" FOREIGN KEY ("FECHAYHORA", "ID")
	  REFERENCES "LIFEFIT"."ELEMENTOCALENDARIO" ("FECHAYHORA", "ENTRENADOR_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LIFEFIT"."ELEMENTOCALENDARIO" ADD CONSTRAINT "ELEMENTCALEND_ENTRENADOR_FK" FOREIGN KEY ("ENTRENADOR_ID")
	  REFERENCES "LIFEFIT"."ENTRENADOR" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LIFEFIT"."PLAN" ADD CONSTRAINT "PLAN_ENTRENA_FK" FOREIGN KEY ("ENTRENA_CLIENTE_ID", "ENTRENA_ID1")
	  REFERENCES "LIFEFIT"."ENTRENA" ("CLIENTE_ID", "ENTRENADOR_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "LIFEFIT"."SESIÓN" ADD CONSTRAINT "SESIÓN_PLAN_FK" FOREIGN KEY ("PLAN_INICIO", "PLAN_ENTRENA_CLIENTE_ID", "PLAN_ENTRENA_ID1", "PLAN_RUTINA_ID")
	  REFERENCES "LIFEFIT"."PLAN" ("INICIO", "ENTRENA_CLIENTE_ID", "ENTRENA_ID1", "RUTINA_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
    ...
    VALUES (1000,'PRUEBA_ENTRENADOR', 'APELLIDOS_ENTRENADOR', '1234', 'DIRECCION_ENTRENADOR', 'CORREO_ENTRENADOR', 'PRUEBA_ENTRENADOR' || 1000);
        
    INSERT INTO ENTRENADOR (ID, DISPONIBILIDAD, CENTRO_ID)
    VALUES (1000, 'SI', 1000);
    
    CREATE USER PRUEBA_ENTRENADOR1000 IDENTIFIED BY PRUEBA;
    GRANT R_ENTRENADOR TO PRUEBA_ENTRENADOR1000;
    
    --CREACION DIETA PARA CLIENTE
    INSERT INTO DIETA (ID, NOMBRE, DESCRIPCIÓN, TIPO) 
    VALUES (1000, 'PRUEBA_DIETA', 'PRUEBA', 'PRUEBA');
    
    --CREACION CLIENTE
    
    INSERT INTO USUARIO (ID, NOMBRE, APELLIDOS, TELEFONO, DIRECCION, CORREO, USUARIOORACLE) 
    VALUES (1001,'PRUEBA_CLIENTE', 'APELLIDOS_ENTRENADOR', '1234', 'DIRECCION_ENTRENADOR', 'CORREO_ENTRENADOR', 'PRUEBA_CLIENTE' || 1001);
    
    
    INSERT INTO CLIENTE (ID, OBJETIVO, CENTRO_ID, DIETA_ID) 
    VALUES (1001, 'PRUEBA', 1000, 1000);
    
    CREATE USER PRUEBA_CLIENTE1001 IDENTIFIED BY PRUEBA;
    GRANT R_CLIENTE TO PRUEBA_CLIENTE1001;
    
    --CREACION GERENTE
    
    INSERT INTO USUARIO (ID,NOMBRE, APELLIDOS, TELEFONO, DIRECCION, CORREO,USUARIOORACLE)
    VALUES (1002,'PRUEBA_GERENTE', 'APELLIDOS_ENTRENADOR', '1234', 'DIRECCION_ENTRENADOR', 'CORREO_ENTRENADOR', 'PRUEBA_GERENTE' || 1002);

    INSERT INTO GERENTE (ID, DESPACHO, HORARIO, CENTRO_ID)
    VALUES (1002, 'PRUEBA', 'PRUEBA', 1000);
    
    CREATE USER PRUEBA_GERENTE1002 IDENTIFIED BY PRUEBA;
    GRANT R_GERENTE TO PRUEBA_GERENTE1002;
    
    --CREACION ELEMENTO CALENDARIO
    
    INSERT INTO ELEMENTOCALENDARIO (FECHAYHORA, ENTRENADOR_ID)
    VALUES ('01/01/0001', 1000);
     
    --CREACION CITA
    
    INSERT INTO CITA (FECHAYHORA,ID, MODALIDAD, CLIENTE_ID)
    VALUES ('01/01/0001', 1000, 'PRUEBA', 1001);
    
    --CREACION ENTRENA
    
    INSERT INTO ENTRENA (ESPECIALIDAD,CLIENTE_ID,ENTRENADOR_ID)
    VALUES ('PRUEBA', 1001, 1000);
    
     --CREACION RUTINA
    
    INSERT INTO RUTINA (ID,NOMBRE,DESCRIPCIÓN)
    VALUES (1000, 'PRUEBA_RUTINA', 'PRUEBA');
    
    --CREACION PLAN
    
    INSERT INTO PLAN (INICIO,FIN,ENTRENA_CLIENTE_ID,ENTRENA_ID1,RUTINA_ID)
    VALUES ('PRUEBA_INICIO', 'PRUEBA_FIN', 1001, 1000, 1000);
    
    --CREACION SESION
    
    INSERT INTO SESIÓN (INICIO,FIN,PRESENCIAL,DESCRIPCIÓN,VIDEO,DATOSSALUD,PLAN_INICIO,PLAN_ENTRENA_CLIENTE_ID,PLAN_ENTRENA_ID1,PLAN_RUTINA_ID)
    VALUES ('PRUEBA_INICIO', 'PRUEBA_FIN', '0', 'PRUEBA_DESCRIPCION','PRUEBA_VIDEO','PRUEBA_DATOSSALUD','PRUEBA_INICIO',1001,1000,1000);
    
    --CREACION EJERCICIO 
    
    INSERT INTO EJERCICIO (ID,NOMBRE,DESCRIPCIÓN,VÍDEO,IMAGEN,PUBLICO)
    VALUES (1000, 'PRUEBA_EJERCICIO', '', '','','S');
    ...
    SELECT * FROM USUARIO WHERE NOMBRE LIKE '%PRUEBA%';
    SELECT * FROM ENTRENADOR WHERE ID = 1000;
    SELECT * FROM CLIENTE WHERE ID = 1001;
    SELECT * FROM GERENTE WHERE ID = 1002;
    SELECT * FROM CITA WHERE ID = 1000;
    SELECT * FROM ELEMENTOCALENDARIO WHERE ENTRENADOR_ID = 1000;
    SELECT * FROM ENTRENA WHERE CLIENTE_ID = 1001 OR ENTRENADOR_ID = 1000;
    SELECT * FROM PLAN WHERE INICIO = 'PRUEBA_INICIO';
    SELECT * FROM SESIÓN WHERE INICIO = 'PRUEBA_INICIO';
    
    --ESTOS NO SE ELIMINAN PORQUE SON INDEPENDIENTES:
    
    --SELECT * FROM CONFORMAN WHERE RUTINA_ID = 1000 OR EJERCICIO_ID = 1000;
